...
const InputPhotos = (props) => {
      ...
      if (bid !== "") {
        if (name !== "") {
          if (phoneEmail !== "") {
            ...
            fetch('http://157.245.184.202:8080/photosbid', {
              method: 'post',
  ...
  return (
    <>
      ...
      <Text style={{ marginLeft: 15 }}> {"Minimum BID: $" + props.photoData.bid} </Text>
      <Text style={{ marginLeft: 15 }}> {"Last BID: $" + props.photoData.lastbid} </Text>
